...
adam.declare_allergan(cheese)
richard.declare_allergan(kiwi)
adam.declare_allergan(kiwi)
richard.declare_allergan(apple)
adam.declare_allergan(apple)

adam.add_recipe_card(pizza, 10)
richard.add_recipe_card(pasta, 100)
richard.add_recipe_card(pizza, 8)
